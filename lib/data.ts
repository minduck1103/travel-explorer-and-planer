...
export const provinces = [
  {
    ...
    attractionCount: 25,
    description: "Thủ đô của Việt Nam với lịch sử hàng nghìn năm văn hiến.",
  },
  {
    id: 2,
    name: "Hồ Chí Minh",
  ...
  },
  {
    ...
    imageUrl: "/placeholder.svg?height=300&width=500",
    attractionCount: 15,
    description: "Cố đô với hệ thống di tích lịch sử phong phú.",
  },
  {
    id: 5,
    name: "Hội An",
    ...
    imageUrl: "/placeholder.svg?height=300&width=500",
    attractionCount: 12,
    description: "Phố cổ xinh đẹp được UNESCO công nhận là Di sản Văn hóa Thế giới.",
  },
  {
    id: 6,
    name: "Nha Trang",
    ...
    imageUrl: "/placeholder.svg?height=300&width=500",
    attractionCount: 14,
    description: "Thành phố biển nổi tiếng với những bãi biển đẹp và hoạt động giải trí phong phú.",
  },
  {
    id: 7,
    name: "Đà Lạt",
